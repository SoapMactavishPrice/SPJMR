({
   extractParams: function(component, pageReference) {
        var state = pageReference.state;
        console.log("URL State Parameters:", state);

        if (state && state.testAttribute) {
            component.set("v.testAttribute", state.testAttribute);
        }
    }
