trigger AdmissionDecisionTrigger on Admission_Decision__c (before insert, before update, before delete, after insert, after update, after delete, after undelete) {
