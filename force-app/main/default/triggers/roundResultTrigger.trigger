trigger roundResultTrigger on Round_Result__c (before insert, before update, before delete, after insert, after update, after delete, after undelete) {
	 RoundResultTriggerHandler handler = new RoundResultTriggerHandler();
