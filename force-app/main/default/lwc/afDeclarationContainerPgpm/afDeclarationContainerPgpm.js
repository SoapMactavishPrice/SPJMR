...
export default class AfDeclarationContainerPgpm extends LightningElement {
...
<div style="background:#f3f3f3; padding:16px; border-radius:4px;">
    ...
    <div>
        <p>I hereby declare that the information provided by me in the application form and the supporting documents is correct. I understand that my academic qualifications and work experience details provided by me are subject to verification by the institution or its authorized representatives. If the furnished information is found misleading or incorrect, I will be responsible for any action taken that the institute may deem fit. I understand that the right to carry out the admission process for Post Graduate Programme in Management (PGPM) lies with SPJIMR. I understand that SPJIMR reserves the exclusive right to reject any application for non-fulfillment of eligibility documentation and/ or for information provided by the applicant being misstated. In such cases, fees paid by the applicant will be forfeited at any stage of admission. I understand that a non-refundable fee of Rs.3000/- as application fee is payable by every applicant for registration for Post Graduate Programme in Management (PGPM). Applicants can make an online payment through Credit/Debit Card (MasterCard/Visa). I undertake to abide by the disciplinary rules and regulations of the institute.</p><br>
    </div>
    <b>Please Note :</b>
    <div style="text-align:center;">
        <ul style="list-style-type: disc; list-style-position: outside; display:inline-block; text-align:left; margin-top:8px; padding-left:30px;">
            ...
            <li>Any communication or update related to the application will be uploaded on the applicant's individual profile, also information will be posted on admissions platform, mail communication may also be done as a service.</li>
    ...
    get isReadOnly() {
        return AfDeclarationContainerPgpm.LOCKED_APPLICATION_STATUSES.includes(this.application?.Application_Status__c) &&
            !AfDeclarationContainerPgpm.UNLOCK_ASSIGNMENT_STATUSES.includes(this.application?.Assignment_Status__c);
    }
