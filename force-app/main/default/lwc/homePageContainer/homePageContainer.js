...
export default class HomePageContainer extends LightningElement {
    ...
    @track currentComponent = 'c_dashboard';
    @track menuItems = [
        { name: 'dashboard', label: 'Dashboard', icon: 'utility:home', component: 'c_dashboard' },
        { name: 'applications', label: 'All Applications Form', icon: 'utility:form', component: 'c_applications' },
        { name: 'profile', label: 'My Profile', icon: 'utility:user', component: 'c_profile' },
        { name: 'queries', label: 'My Queries', icon: 'utility:question', component: 'c_queries' },
        { name: 'communication', label: 'My Communication', icon: 'utility:email', component: 'c_communication' },
        { name: 'payments', label: 'My Payments', icon: 'utility:money', component: 'c_payments' },
        { name: 'faq', label: 'FAQ', icon: 'utility:info', component: 'c_faq' },
