...
export default class AfBasicDetailsContainerPgpm extends LightningElement {
    ...
    `
                ...
                rows: [
                    {
                        ...
                        fields: ["First_Name__c","Middle_Name__c","Last_Name__c","Gender__c","Date_of_Birth_As_Per_10th_Marksheet__c","FormattedAge__c",
                            "Marital_Status__c","Name_Of_Spouse__c","Contact_No_of_Spouse__c", "Mother_s_Name__c", "Category__c", "OtherCategory__c",
                            "LinkedIn_Profile_URL__c","Nationality__c","HavePassport__c","PassportNumber__c","AadhaarCardNumber__c"
                        ]
                    },
                ],
                fields: [
                    ...
                    { api: "HavePassport__c", type: "picklist", span:3, label: "Do you have a Passport?", required: true },
            ...
            parentDetails: {
                ...
                rows: [
                    ...
                    {
                        fluid: true,
                        fields: ["Father_s_Name__c", "Mother_s_Name__c"]
                    },
    ...
    get isReadOnly() {
        return AfBasicDetailsContainerPgpm.LOCKED_APPLICATION_STATUSES.includes(this.application?.Application_Status__c) &&
            !AfBasicDetailsContainerPgpm.UNLOCK_ASSIGNMENT_STATUSES.includes(this.application?.Assignment_Status__c);
    }
    ...
    handleSectionFieldChange(e) {
        ...
        if(api === "HavePassport__c") {
            ...
            } else if(this.basic[sectionKey][api] === 'Yes')  {
