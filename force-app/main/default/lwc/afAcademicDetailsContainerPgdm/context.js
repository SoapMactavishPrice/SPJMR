...
export const context = {
    ...
    parents: [
        ...
        },
        {
            ...
            fieldsToQuery: [ "Id", "Name", "Board_University__c", "Other_Board_University__c", "Examination_ID__c", "School_Institute__c", "MonthAndYearOfPassing__c", "Marking_Scheme__c", "Maximum_Marks__c", "Obtained_Marks__c", "Percentage__c", "ConversionFormula__c" ]
        },
        {
            logicalName: "twelfth",
            recordName: "12th",
        ...
        },
        {
            ...
            recordName: "UG",
            sobject: "Academic_Detail__c",
            fieldsToQuery: ["Id","Name","State__c","OtherState__c","University__c","OtherUniversity__c","College__c","OtherCollege__c","Mode_of_Study__c","InstituteCity__c","Degree_Type__c","Degree__c","OtherDegree__c","Specialization_Name__c",'Pattern_of_Examination__c']
        },
        {
        ...
        },
        {
            ...
            recordName: "PG",
            sobject: "Academic_Detail__c",
            fieldsToQuery: ["Id","Name","State__c","OtherState__c","University__c","OtherUniversity__c","College__c","OtherCollege__c","Mode_of_Study__c","InstituteCity__c","Degree_Type__c","Degree__c","OtherDegree__c","Specialization_Name__c"]
        },
        {
    ...
    children: [
        ...
        },
        {
            ...
            fieldsToQuery: [
                ...
                "Name_of_Qualification__c",
                "Name_of_Institute_Picklist__c",
                "Name_of_Institute__c",
