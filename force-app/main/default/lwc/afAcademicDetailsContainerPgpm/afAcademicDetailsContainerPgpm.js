...
export default class AfAcademicDetailsContainerPgpm  extends LightningElement {
...
`
        ...
        this.metadata.twelfth.fields[3].min = "1985-01-01";
        this.metadata.twelfth.fields[3].max= new Date().toISOString().split('T')[0];
        // this.metadata.twelfth.fields[3].min = "2007-01-01";
        // this.metadata.twelfth.fields[3].max= new Date().toISOString().split('T')[0];
        this.metadata.twelfth.fields[7].visibleWhen = { 'twelfth.Marking_Scheme__c': 'CGPA' };
...
<b>Note: </b>Overall percentage / CGPA should be the same as mentioned in your mark sheet
        ...
        this.metadata.graduation = {
            ...
            note: {
                ...
                type:'note',
                text: `
<b>Note: </b>Please mention graduation percentage as mentioned in the final semester/year marksheet . Please note, percentage will be verified as part of document verification process.
                `
            },
            fields: [
                { 
    ...
    _injectPicklists() {
        ...
        //Academic break
        setOptions('haveAcademicBreak','AcademicBreakAfter__c',resolveOptions('AcademicBreakAfter__c'));
    ...
    _buildSectionRenderModel(sectionKey, options = {}) {
        ...
        if (this._isSequentialSection(sectionKey, sectionData)) {
            section.rows.push(
                ...(meta?.layout === 'fluid'
    ...
    handleSectionFieldChange(e) {
        ...
        if (!['professionalQualification'].includes(sectionKey)) {
    ...
    validateAll() {
        ...
        if (hasPQ === 'Yes') {
            ...
            pqMeta.forEach(f => addResolvedMissing('professionalQualification', f));
    ...
    get isReadOnly() {
        return AfAcademicDetailsContainerPgpm.LOCKED_APPLICATION_STATUSES.includes(this.application?.Application_Status__c) &&
            !AfAcademicDetailsContainerPgpm.UNLOCK_ASSIGNMENT_STATUSES.includes(this.application?.Assignment_Status__c);
    }
