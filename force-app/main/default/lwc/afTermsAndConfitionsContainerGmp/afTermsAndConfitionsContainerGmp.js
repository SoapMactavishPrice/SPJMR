...
import updateStage from '@salesforce/apex/AcademicController.updateStage';
...
5. SPJIMR may communicate with you via email.
    ...
    async fetchForm(appId) {
        try {
            ...
            console.log("fetched Form resp", JSON.stringify(resp, null, 2));
    ...
    handleDocsFetched(event) {
        ...
        console.log('handleDocsFetched print ', this.tc[sectionKey][api]);
        this.tc[sectionKey].fileInfo ||= {}
        this.tc[sectionKey].fileInfo[api] = {fileLength: files?.length, files: files};

        console.log('handleDocsFetched file length print ', this.tc[sectionKey].fileInfo[api].fileLength);
    ...
    buildSavePayload() {
        ...
        console.log("buildSavePayload", JSON.stringify(out));
        return out;
    }
    ...
    @api async saveForm() {
        ...
        try {
            ...
            console.log("saveForm", JSON.stringify(payload));
