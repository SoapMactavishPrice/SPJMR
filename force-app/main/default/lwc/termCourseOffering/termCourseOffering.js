...
import BATCH_FIELD from '@salesforce/schema/AcademicTerm.AcademicYearId';

const TERM_FIELDS = [BATCH_FIELD];

export default class TermCourseOffering extends LightningElement {
    @api recordId; // Term ID from record page
    ...
    wiredTerm({ error, data }) {
        ...
        if (data) {
            ...
            this.termBatchGroupId = data.fields.AcademicYearId.value;
            this.loadCourses();
        } else if (error) {
