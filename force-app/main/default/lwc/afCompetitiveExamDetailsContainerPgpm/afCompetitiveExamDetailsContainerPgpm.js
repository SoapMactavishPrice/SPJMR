...
export default class AfCompetitiveExamDetailsContainerPgpm extends LightningElement {
    ...
    get isReadOnly() {
        return AfCompetitiveExamDetailsContainerPgpm.LOCKED_APPLICATION_STATUSES.includes(this.application?.Application_Status__c) &&
            !AfCompetitiveExamDetailsContainerPgpm.UNLOCK_ASSIGNMENT_STATUSES.includes(this.application?.Assignment_Status__c);
    }
...
• <a href="https://www.spjimr.org/course/post-graduate-programme-in-management-pgpm/admissions/" target="_blank">Click here</a> to know the Important Dates of the Cohort.<br/><br/>
            `
            },
            rows: [],
            fields: [
