...
<div style="background:#f3f3f3; padding:16px; border-radius:4px;">
    ...
    <div>
        <p>I declare that the information provided by me in the application form and the supporting documents details provided by me are correct. I understand that my academic qualifications and work experience details provided by me are subject to verification by the institution or its authorized representatives. If the furnished information is found misleading or incorrect, I will be responsible for any action taken that the institute may deem fit.I understand that the right to carry out the admission process for PGDM &amp; PGDM (BM) lies with SPJIMR. I understand that SPJIMR reserves the exclusive right to reject any application for non-fulfillment of eligibility documentation and/ or for information provided by the applicant being misstated. In such cases,fees paid by the applicant will be forfeited at any stage of admission. I understand that a non-refundable fee of Rs. 2500/- as application fee is payable by every applicant for registration for each of the programmes PGDM and PGDM (BM) when applied separately (Rs. 5000/- for international applicants for the PGDM programme). I further confirm that a non-refundable fee of Rs. 4000/- as a combined application fee is payable by every applicant when applying for both PGDM and PGDM (BM) together. Applicants can make an online payment. I undertake to abide by the disciplinary rules and regulations of the institute.</p><br>
    </div>
